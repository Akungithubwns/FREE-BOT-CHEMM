...
console.log(color('  🦄Xeon Bot Inc. 2022🦄','mediumseagreen'))
    ...
    const XeonBotInc = XeonBotIncConnect({
        ...
        browser: ['By Faturr','Chrome','1.0.0'],
        auth: state,
        version
    })
...
let buttons = [
{buttonId: `anjayalok🗿😎`, buttonText: {displayText: 'Welcome Beban'}, type: 1}
]
let buttonMessage = {
...
└┬❖ 「 @${xeonName.split("@")[0]}  」
   ...
   //you fail to put, i sue you for sure!
let buttons = [
{buttonId: `Beban Keluar 1 aj `, buttonText: {displayText: 'Jan kesini lagi ya beban  🥀'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./XeonMedia/theme/cheems.xlsx'),
mimetype: docs,
